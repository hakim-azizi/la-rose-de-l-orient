...
$nbart2=mysqli_query($connectionbd,("SELECT COUNT(*) FROM produit $where AND stock>0")or die(6);
...
<div id="accueil">
<?php
$mod1=mysqli_query($connectionbd,("SELECT * FROM produit $where  AND `stock` > 0 $order");
while($accueil=mysqli_fetch_array($mod1)){extract($accueil);
echo"<br/><img src='$url$grande_image'><br/>";//face
$grande_image_petit=str_replace('.jpg','-petit.jpg',$grande_image);
echo"<img src='$url$grande_image_petit'><br/>";
$grande_image_min=str_replace('.jpg','-min.jpg',$grande_image);
echo"<img src='$url$grande_image_min'><br/>";


$grande_image_profile=str_replace('.jpg','-profile.jpg',$grande_image);//profile
echo"<br/><img src='$url$grande_image_profile'><br/>";
$grande_image_profile_petit=str_replace('.jpg','-petit.jpg',$grande_image_profile);
echo"<img src='$url$grande_image_profile_petit'><br/>";
$grande_image_profile_min=str_replace('.jpg','-min.jpg',$grande_image_profile);
echo"<img src='$url$grande_image_profile_min'><br/>";


$grande_image_dos=str_replace('.jpg','-dos.jpg',$grande_image);//dos
echo"<br/><img src='$url$grande_image_dos'><br/>";
$grande_image_dos_petit=str_replace('.jpg','-petit.jpg',$grande_image_dos);
echo"<img src='$url$grande_image_dos_petit'><br/>";
$grande_image_dos_min=str_replace('.jpg','-min.jpg',$grande_image_dos);
echo"<img src='$url$grande_image_dos_min'><br/>";
