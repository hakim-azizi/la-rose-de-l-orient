...
$article1=mysqli_query($connectionbd,"SELECT * FROM produit WHERE stock>0 ORDER BY RAND() LIMIT 10");
...
<li id="image<?php echo $nbarticle; ?>" class="texteredim image_<?php echo $nbarticle; ?> image-li"<?php if($nbarticle!=0){ echo' style="display:none;"'; } ?>><a href="<?php echo $urlproduit; ?>"><script>
<!--
