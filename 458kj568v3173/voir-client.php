...
$membre1 = mysqli_query($connectionbd,"SELECT * FROM `client`");
...
<div align="center"> 
<form action="modifier-client.php" method="post" name="info" id="info">
...
<form action="contactez-client.php" method="post" name="contact" id="contact">
...
<input name="Submit" type="submit" class="Style8" value="ecrire un mail au client" /></form>
      </div></td>
    </tr>
  </table>
  </font>
